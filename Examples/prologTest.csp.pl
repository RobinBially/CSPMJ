...
'agent'('I'(_A2),'a4','src_span'(22,1,22,9,8,8)).
...
'bindval'('m','ifte'('true','int'(1),'int'(1),'src_span'(68,5,68,7,2,2),'src_span'(68,12,68,18,6,6),'src_span'(68,19,68,25,6,6)),'src_span'(68,1,68,26,25,25)).
'bindval'('n','repChoice'(['comprehensionGuard'('true')],'int'(1),'src_span'(69,8,69,12,4,4)),'src_span'(69,1,69,16,15,15)).
'bindval'('o','repInternalChoice'(['comprehensionGenerator'('int'(1),'int'(2))],'int'(1),'src_span'(70,9,70,12,3,3)),'src_span'(70,1,70,16,15,15)).
'bindval'('p','repInterleave'(['comprehensionGenerator'('int'(1),'int'(2)),'comprehensionGuard'('true')],'int'(2),'src_span'(71,9,71,17,8,8)),'src_span'(71,1,71,21,20,20)).
'bindval'('q','procRepAParallel'(['comprehensionGuard'('int'(1))],'pair'('true','int'(1)),'src_span'(72,8,72,9,1,1)),'src_span'(72,1,72,20,19,19)).
'bindval'('r','repSequence'(['comprehensionGuard'('int'(1))],'int'(2),'src_span'(73,7,73,8,1,1)),'src_span'(73,1,73,12,11,11)).
'bindval'('s','procRepSharing'('true',['comprehensionGuard'('int'(1))],'int'(2),'src_span'(74,14,74,15,1,1)),'src_span'(74,1,74,19,18,18)).
'bindval'('t','procRepLinkParallel'('linkList'(['link'('int'(1),'int'(2))]),['comprehensionGuard'('true')],'true','src_span'(75,13,75,17,4,4)),'src_span'(75,1,75,24,23,23)).
'bindval'('u3','procRepSyncParallel'('int'(1),['comprehensionGuard'('true')],'true','src_span'(76,11,76,15,4,4)),'src_span'(76,1,76,22,21,21)).
'comment'('lineComment'('-- This is an End-Of-File-Comment.','src_span'(78,1,78,35,34,34))).
...
'symbol'('m','m','src_span'(68,1,68,2,1,1),'Ident (Groundrep.)').
'symbol'('n','n','src_span'(69,1,69,2,1,1),'Ident (Groundrep.)').
'symbol'('o','o','src_span'(70,1,70,2,1,1),'Ident (Groundrep.)').
'symbol'('p','p','src_span'(71,1,71,2,1,1),'Ident (Groundrep.)').
'symbol'('q','q','src_span'(72,1,72,2,1,1),'Ident (Groundrep.)').
'symbol'('r','r','src_span'(73,1,73,2,1,1),'Ident (Groundrep.)').
'symbol'('s','s','src_span'(74,1,74,2,1,1),'Ident (Groundrep.)').
'symbol'('t','t','src_span'(75,1,75,2,1,1),'Ident (Groundrep.)').
'symbol'('u','u','src_span'(63,4,63,5,1,1),'Ident (Groundrep.)').
'symbol'('u2','u','src_span'(64,6,64,7,1,1),'Ident (Prolog Variable)').
'symbol'('u3','u','src_span'(76,1,76,2,1,1),'Ident (Groundrep.)').
