...
'parserVersionStr'('CSPMJ V0.49').
'agent'('l'(_x),'let'(['bindval'('u','int'(1),'src_span'(2,4,2,9,5,5)),'agent'('b'(_u2),'let'(['bindval'('c',_u2,'src_span'(4,6,4,11,5,5))],'int'(1)),'src_span'(3,4,5,13,9,9))],_x),'src_span'(1,1,6,11,10,10)).
...
'symbol'('l','l','src_span'(1,1,1,2,1,1),'Function or Process').
