...
'agent'('I'(_a),'val_of'('A','src_span'(20,8,20,9,1,1)),'src_span'(20,1,20,9,8,8)).
...
'bindval'('h','lambda'([_a3,_b2],'int'(3)),'src_span'(45,1,45,11,10,10)).
'comment'('lineComment'('-- This is an End-Of-File-Comment.','src_span'(46,1,46,35,34,34))).
...
'symbol'('a','a','src_span'(20,3,20,4,1,1),'Ident (Prolog Variable)').
'symbol'('a2','a','src_span'(38,1,38,2,1,1),'Ident (Groundrep.)').
'symbol'('a3','a','src_span'(45,6,45,7,1,1),'Ident (Prolog Variable)').
'symbol'('b','b','src_span'(39,1,39,2,1,1),'Ident (Groundrep.)').
'symbol'('b2','b','src_span'(45,8,45,9,1,1),'Ident (Prolog Variable)').
...
'symbol'('h','h','src_span'(45,1,45,2,1,1),'Ident (Groundrep.)').
